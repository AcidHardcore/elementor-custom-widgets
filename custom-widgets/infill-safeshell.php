...
class Infill_Safeshell extends Widget_Base
{
    ...
    public function __construct($data = [], $args = null)
    {
        ...
        $css_version = $theme_version . '.' . filemtime(get_template_directory() . '/css/widget-infill-safeshell.css');
        wp_register_style('widget-infill-safeshell', get_template_directory_uri() . '/css/widget-infill-safeshell.css', array('main-styles'), $css_version);

    }

    public function get_style_depends()
    {
        return ['widget-content', 'widget-infill-safeshell'];
    }

    public function get_name()
    {
        return 'infill-safeshell';
    }

    public function get_title()
    {
        return __('Infill Safeshell', 'elementor-custom-widgets');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section('section_intro', [
            'label' => __('Infill Safeshell', 'elementor-custom-widgets'),
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .infill-safeshell__text' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .infill-safeshell__text > *',
            ]
        );
    ...
    protected function render()
    {
      ...
      <div id="<?= esc_attr($section_id) ?>" class="mt-300 section infill-safeshell wow fadeInUp">
        <div class="grid-cont">
          <div class="grid-row grid-row--nog grid-row--jcc">
            <div class="grid-col grid-col--8 grid-col--md-12">
                ...
                <?php if (isset($settings['text'])) : ?>
                  <div class="mt-100 infill-safeshell__text"><?= wp_kses_post($settings['text']) ?></div>
                <?php endif; ?>
          ...
          <?php if (isset($settings['number']) && !empty($settings['number']['id'])) : ?>
            <div class="infill-safeshell__num"><?= file_get_contents(wp_get_original_image_path($settings['number']['id'])); ?></div>
          <?php endif; ?>
