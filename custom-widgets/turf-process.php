...
class Turf_Process extends Widget_Base
{
    ...
    public function __construct($data = [], $args = null)
    {
        ...
        $css_version = $theme_version . '.' . filemtime(get_template_directory() . '/css/widget-turf-process.css');
        wp_register_style('widget-turf-process', get_template_directory_uri() . '/css/widget-turf-process.css', array('main-styles'), $css_version);

    }

    public function get_style_depends()
    {
        return ['widget-content', 'widget-turf-process'];
    }
    ...
    {
        return __('Turf Process', 'elementor-custom-widgets');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section('section_intro', [
            'label' => __('Turf Process', 'elementor-custom-widgets'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'white',
                'selectors' => [
                    '{{WRAPPER}} .synt-turf-inst-process__title' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .synt-turf-inst-process__title',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .synt-turf-inst-process__text > *' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .synt-turf-inst-process__text > *',
            ]
        );
    ...
    protected function render()
    {
      ...
      <div id="<?= esc_attr($section_id) ?>" class="section synt-turf-inst-process">
        <div class="grid-cont">
          <div class="grid-row grid-row--nog grid-row--jcc">
            <div class="grid-col grid-col--7 grid-col--lg-9 grid-col--md-12 wow fadeInUp">
                ...
                <?php if (isset($settings['title'])) : ?>
                  <h2 class="num-title synt-turf-inst-process__title">
                ...
                <?php if (isset($settings['text'])) : ?>
                  <div class="mt-150 synt-turf-inst-process__text"><?= wp_kses_post($settings['text']) ?></div>
                <?php endif; ?>
