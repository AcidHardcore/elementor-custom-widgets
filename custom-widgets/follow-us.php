...
class Follow_Us extends Widget_Base
{
    ...
    public function __construct($data = [], $args = null)
    {
        ...
        $css_version = $theme_version . '.' . filemtime(get_template_directory() . '/css/widget-follow-us.css');
        wp_register_style('widget-follow-us', get_template_directory_uri() . '/css/widget-follow-us.css', array('main-styles'), $css_version);
    ...
    {
        return __('Follow Us', 'elementor-custom-widgets');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->start_controls_section('section_intro', [
            'label' => __('Follow Us', 'elementor-custom-widgets'),
    ...
    protected function render()
    {
      ...
      <div id="<?= esc_attr($section_id) ?>" class="section follow-us <?= esc_attr($section_class) ?>">
        <div class="grid-cont grid-cont--sm">
          <div class="grid-row grid-row--aic grid-row--jcb">
            <div class="grid-col grid-col--4 grid-col--md-5 grid-col--sm-12 wow fadeInUp">

                <?php if (isset($settings['title'])) : ?>
                  <h2 class="tc-primary follow-us__title">
              ...
              <div class="follow-us__links">
                  <?php foreach ($settings['socials'] as $item) : ?>
                      ...
                      <a href="<?php echo esc_url($item['cta_link']['url']) ?>"
                         class="follow-us__item" <?= $this->get_render_attribute_string('cta_link'); ?>>
